...
class GZIP:
    ...
    def decompress(self):
        ...
        while not BFINAL == 1:
            ...
            print(f"Comprimento dos codígos (19 entradas): {codesLength}")
    ...
    def readFormat(self):
        ...
        HCLEN = self.readBits(4) #porque temos que ler 4 bits
    ...
    def codesLengthAlphabet(self, HCLEN):
        ...
        for i in range(HCLEN):
            codesLength[order[i]] = self.readBits(3) #ler os 3 bits de cada numero e entrar no array
...
if __name__ == '__main__':
    ...
    fileName = "C:\\Users\\Bodunchik\\OneDrive\\Desktop\\University\\TI\\TP2 - Deflate\\TP2 - Deflate\\base code - python\\FAQ.txt.gz"
    if len(sys.argv) > 1:
        fileName = sys.argv[1]
